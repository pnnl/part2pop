...
# This file lives at:
#   <repo_root>/tests/unit/population/factory/test_mam4.py
# So:
#   parents[0] = .../tests/unit/population/factory
#   parents[1] = .../tests/unit/population
...
MAM_OUTPUT_PATH = MAM4_EXAMPLE_DIR / "mam_output.nc"
NAMELIST_PATH = MAM4_EXAMPLE_DIR / "namelist"
...
def test_mam4_build_conserves_number_and_composition(tmp_path):
    ...
    """
    mam_output_path = MAM_OUTPUT_PATH
