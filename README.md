...
[![CI](https://github.com/lfierce2/part2pop-dev/actions/workflows/ci.yml/badge.svg)](https://github.com/lfierce2/part2pop-dev/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/lfierce2/part2pop-dev/branch/main/graph/badge.svg?token=MUDTVHNO07)](https://codecov.io/gh/lfierce2/part2pop-dev)
...
plotter.plot(pop, ax, label=s["label"])
